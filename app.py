...
Original file is located at
    https://colab.research.google.com/drive/11L50sYKCVJTGUrw9HJp8JF8i-o072Erm
...
data_preparada = pd.get_dummies(data_preparada, columns=['videojuego','Plataforma','Sexo','Consumidor_habitual'])
data_preparada.head()
